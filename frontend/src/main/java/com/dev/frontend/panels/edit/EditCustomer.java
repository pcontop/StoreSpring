...
public class EditCustomer extends EditContentPanel 
{
	...
	public boolean bindToGUI(Object o) 
	{
		...
		txtCreditLimit.setText(TextUtil.convert(customer.getCreditLimit()));
		txtCurrentCredit.setText(TextUtil.convert(customer.getCurrentCredit()));		
		return true;
	}
	...
	public Object guiToObject() 
	{
		return CustomerDto.create()
				...
				.setPhone1(txtPhone1.getText())
				.setPhone2(txtPhone2.getText())
				.setCreditLimit(Utils.parseDouble(txtCreditLimit.getText()))
				.setCurrentCredit(Utils.parseDouble(txtCurrentCredit.getText()))
				.build();
	}
